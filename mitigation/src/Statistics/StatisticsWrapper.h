...
// wrapper for Stats::DataWrapVec
template<class StatType>
class StatBaseVec : public StatBase<StatType> 
{
  protected:
...
// wrapper for Stats::ScalarBase
template<class StatType>
class ScalarStatBase : public StatBase<StatType> 
{
  public:
...
// wrapper for Stats::VectorBase
template<class StatType, class Element>
class VectorStatBase : public StatBaseVec<StatType> 
{
  protected:
...
// wrapper for Stats::DistBase
template<class StatType>
class DistStatBase : public StatBase<StatType> 
{
  public:
    template<typename U>
